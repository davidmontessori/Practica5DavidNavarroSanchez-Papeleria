		...
		do {
			...
			case 1: // Insertar
				do {
					...
					System.out.println("4. Insertar producto en proveedor");
					...
					case 2: // Producto
						...
						if (tipo == 1) {
							...
							while (!colorValido) {
							    ...
							    String colorDado = input.nextLine();

							    try {
							        color = Colores.valueOf(colorDado.toUpperCase());
							        colorValido = true;
							    } catch (IllegalArgumentException e) {
							        System.out.println("Color no válido. Intenta con uno de los disponibles.");
							    }
							}
					...
					case 4:
						...
						gestor.introducirProductoProveedor(nombreProd, marcaProd, nombrePro);
