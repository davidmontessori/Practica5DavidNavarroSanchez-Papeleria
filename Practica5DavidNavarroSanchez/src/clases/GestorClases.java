...
public class GestorClases {
	 ...
	 * @param proveedor
	 * @param borrable
	 * @param color, recoge como valores validos unicamente los disponibles en la clase enum Colores
	 * @param tipoTinta
	 */

	public void altaProducto(String nombre, double precio, String marca, Proveedores proveedor, boolean borrable,
			Colores color, String tipoTinta) {
		try {
		...
		try {
			...
			for (Empleado empleados : listaEmpleados) {
				if (empleados != null) {
					...
					System.out.println("salario anual: "+empleados.salario_anual());
				}
		...
		try {
			...
			for (Producto productos : listaProductos) {
				if (productos != null) {
					...
					System.out.println("Es premium: "+productos.esPremium());
				}
			}
	...
	public void crearProductoProveedor(String nombreProducto, double precio, String marcaProducto,
			String nombreProveedor, boolean borrable, Colores color, String tipoTinta) {
